...
from package.smart_gestures.alphabet.vgt_model.model import create_model, DEVICE, MODEL_DIR
from package.smart_gestures.alphabet.vgt_model.data import _normalize_landmarks, get_classes
