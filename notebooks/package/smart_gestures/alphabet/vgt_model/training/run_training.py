...
from alphabet.vgt_model import (
    get_loaders,
    get_classes,
)
from alphabet.vgt_model.model import create_model, save_model
from alphabet.vgt_model.data import load_dataset_normalized, split_dataset, get_loaders
...
def main(args):
    ...
    dataset = load_dataset_normalized(
        HAND_LANDMARKS_JSON, # TODO: define HAND_LANDMARKS_JSON path
        as_sequence=False,
